...
CREATE INDEX IF NOT EXISTS idx_agency_events_agency ON agency_events(agency_name, id);
CREATE INDEX IF NOT EXISTS idx_agency_events_run ON agency_events(run_id, id) WHERE run_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_agency_events_created ON agency_events(created_at, id);
