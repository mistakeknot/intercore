...
var (
	...
	ErrInvalidMetadata = errors.New("invalid run metadata")
	ErrSealedMetadata  = errors.New("sealed close-gate metadata cannot be changed")
	ErrStaleMetadata   = errors.New("run metadata changed during update")
)
