...
Full `ic` command reference is in [AGENTS.md](./AGENTS.md). Key commands: `ic run`, `ic dispatch`, `ic gate`, `ic events`, `ic lock`, `ic coordination`, `ic cost`, `ic discovery`. Use `ic <command> --help` for usage.
